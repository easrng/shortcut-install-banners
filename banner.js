...
if (iOS && !navigator.standalone && localStorage.getItem("_shortcutInstalled") != "1") {
    ...
    t.innerHTML = `<div style="text-align: center;"><a href="javascript:;" style="color: #7f7f7e;text-decoration:none;" onclick="localStorage.setItem('_shortcutInstalled','1');document.querySelector(':root').style.transform='';this.parentElement.parentElement.remove();">&times;</a></div>
